...
class PerformanceMonitor:
    ...
    def record_batch(self, is_decode: bool, sequences: List, elapsed: float, 
        ...
        if high_priority_latencies:
            ...
            print(f"Iteration LS Avg Latency = {avg_high_priority_latency:.3f} sec, "
            ...
            print(f"{phase} LS Overall Avg Latency = {overal_avg_latency:.3f} sec, "
        ...
        if turnaround_times:
            print(f"Avg Turnaround Time: {avg_turnaround:.3f} sec")
            if hp_turnaround_times:
                print(f"LS Avg Turnaround Time: {avg_hp_turnaround:.3f} sec")
    ...
    def print_final_stats(self):
        ...
        if self.hp_turnaround_times:
            ...
            print(f"Overall LS Avg Turnaround Time: {overall_hp_avg_turnaround:.3f} sec")
        print("="*80 + "\n")